...
const Login = () => {
  ...
  const { signInWithGoogle, signInWithEmail, signUpWithEmail, sendPasswordReset, showMessage } = useAuth();
  ...
  const blurb = mode === 'signup' ? '30 free credits, worth up to 30 transcription minutes. No card needed.'
