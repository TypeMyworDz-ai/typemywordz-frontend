  ...
  return (
    <main className="tm-trainee-page">
      <div className="tm-trainee-card">
        ...
        <div className="tm-trainee-price"><strong>$20 USD</strong><span>One-time training enrolment. Kora is the primary checkout; Paystack appears only if Kora cannot complete the payment.</span></div>
